...
export default function ModalPokemon({isShowModal, setIsShowModal, currentPokemonId, types, top, left}) {
  ...
  return (
    <>
      <div className={`modal modal-main ${isShowModal ? "is-active" : ""}`}>
